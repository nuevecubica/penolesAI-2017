...
class des_amb_2Page: ImagePage {
    override var viewController: UIViewController {
        return des_amb_2ViewController(image: UIImage(named: imageName)!)
    }
}

class des_amb_2ViewController: PageWithButtonsViewController {
    override func viewDidLoad() {
        ...
        */
        ...
        NSLayoutConstraint.activate([
            button_vid.leadingAnchor.constraint(equalTo: imageView.leadingAnchor, constant: 620.0 * imageScale),
