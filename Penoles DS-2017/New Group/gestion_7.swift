...
class gestion_7Page: ImagePage {
    override var viewController: UIViewController {
        return gestion_7ViewController(image: UIImage(named: imageName)!)
    }
}

class gestion_7ViewController: PageWithButtonsViewController {
    override func viewDidLoad() {
        ...
        */
        ...
        NSLayoutConstraint.activate([
            button_vid.leadingAnchor.constraint(equalTo: imageView.leadingAnchor, constant: 325.0 * imageScale),
    ...
    @IBAction func btn_vid_Pressed(_ sender: UIButton) {
        showVideoPopup(videoName: "gestion_07_vid")
    }
